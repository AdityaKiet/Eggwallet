...
/**
 * Created by adityaagrawal on 18/12/15.
 */
public class ProfileUpdateAsyncTask extends AsyncTask<Void, Void, Void> implements NetworkContsants {
    ...
    public ProfileUpdateAsyncTask(Context context, UserxDTO userxDTO) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        list.add(new BasicNameValuePair("name", userxDTO.getName()));
        list.add(new BasicNameValuePair("email", userxDTO.getEmail()));
        list.add(new BasicNameValuePair("dob", userxDTO.getDob()));
        list.add(new BasicNameValuePair("accessToken", userxDTO.getAccessToken()));
        list.add(new BasicNameValuePair("city", userxDTO.getCity()));
