 ...
 */
public class ResendOTPAsyncTask extends AsyncTask<Void, Void, Void> implements NetworkContsants, EggWallet {
    ...
    public ResendOTPAsyncTask(Context context, UserxDTO userxDTO) {
